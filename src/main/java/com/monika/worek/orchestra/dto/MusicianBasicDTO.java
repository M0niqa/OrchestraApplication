...
public class MusicianBasicDTO extends UserBasicDTO {
    ...
    public MusicianBasicDTO(Long id, String firstName, String lastName, Instrument instrument, Set<Project> pendingProjects, Set<Project> acceptedProjects, Set<Project> rejectedProjects) {
